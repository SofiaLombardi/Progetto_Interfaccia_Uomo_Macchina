...
namespace Flower_app.Web.Features.Login
{
    ...
    [GeneratedCode("R4Mvc", "1.0"), DebuggerNonUserCode]
    public partial class R4MVC_LoginController : Flower_app.Web.Features.Login.LoginController
    {
        ...
        [NonAction]
        partial void LoginOverride(R4Mvc_Microsoft_AspNetCore_Mvc_ActionResult callInfo, Flower_app.Web.Features.Login.LoginViewModel model);
        [NonAction]
        public override System.Threading.Tasks.Task<Microsoft.AspNetCore.Mvc.ActionResult> Login(Flower_app.Web.Features.Login.LoginViewModel model)
        {
            var callInfo = new R4Mvc_Microsoft_AspNetCore_Mvc_ActionResult(Area, Name, ActionNames.Login);
